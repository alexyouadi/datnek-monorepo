...
import { EventAction } from '../store/action/action';
...
export class EventFormComponent  {
  ...
  onSubmit(event: EventInput.Update) {
    ...
    if (this.form.valid) {
      ...
      this.toastr.success('Événement mise a jour avec succès !', 'Succès', {
